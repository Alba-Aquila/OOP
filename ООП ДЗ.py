class Student:
    ...
    def __str__(self):
        ...
        res = (
            ...
            f"Проходит курсы: {courses_in_progress_string}\n"
            f"Завершил курсы: {finished_courses_string}"
        )
        return res
...
best_lecturer_1 = Lecturer("Стив", "Джобс")
best_lecturer_1.courses_attached += ["Python"]

best_lecturer_2 = Lecturer("Билл", "Гейтс")
best_lecturer_2.courses_attached += ["Java"]

best_lecturer_3 = Lecturer("Гейб", "Ньюэлл")
...
cool_reviewer_2 = Reviewer("Гвидо ван", "Россум")
cool_reviewer_2.courses_attached += ["Python"]
cool_reviewer_2.courses_attached += ["Java"]

student_1 = Student("Эйден", "Пирс")
student_1.courses_in_progress += ["Python"]
student_1.finished_courses += ["Введение в программирование"]

student_2 = Student("Томас", "Андерсон")
student_2.courses_in_progress += ["Java"]
student_2.finished_courses += ["Введение в программирование"]

student_3 = Student("Джейсон", "Стетхем")
...
print()
print(
    f"Результат сравнения студентов (по средним оценкам за Домашнее Задание): "
